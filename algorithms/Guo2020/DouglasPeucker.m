function PointList_reduced = DouglasPeucker(PointList, tolerance_distance, showdata)
...
if ischar(tolerance_distance)
    switch upper(tolerance_distance)
        case 'AUTO'
            tolerance_distance = 0.02*...
